/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 72b5f1ddbf16f7d8220a4ee8d132adb7)
// Runtime types generated with workerd@1.20250617.0 2025-06-27 
declare namespace Cloudflare {
	interface Env {
		PUBLIC_ClientId_Prod: string;
		PUBLIC_ClientId_Dev: string;
