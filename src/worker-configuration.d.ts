/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 39ba8fb87e3b70c0339097d34ec51373)
// Runtime types generated with workerd@1.20250617.0 2025-06-27 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		"sm-website-cache": KVNamespace;
		ClientApiOrigin: "https://client-api.supportmail.dev" | "https://client-api-dev.supportmail.dev";
		PUBLIC_ClientId: string;
		PUBLIC_botPermissions: string;
		SUPPORTMAIL_API_KEY: string;
		CLIENT_SECRET: string;
		BOT_TOKEN: string;
		PUBLIC_discordRedirectUri: string;
		OWNER_ID: string;
		mongoUri: string;
		JWT_SECRET: string;
		DB_ENCRYPTION_KEY: string;
		DB_ENCRYPTION_IV: string;
		PUBLIC_DashboardUrl: string;
		PUBLIC_githubOrga: string;
		PUBLIC_legalHost: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ClientApiOrigin" | "PUBLIC_ClientId" | "PUBLIC_botPermissions" | "SUPPORTMAIL_API_KEY" | "CLIENT_SECRET" | "BOT_TOKEN" | "PUBLIC_discordRedirectUri" | "OWNER_ID" | "mongoUri" | "JWT_SECRET" | "DB_ENCRYPTION_KEY" | "DB_ENCRYPTION_IV" | "PUBLIC_DashboardUrl" | "PUBLIC_githubOrga" | "PUBLIC_legalHost">> {}
}
